...
import com.bookingcar.service.CustomerService;
...
/**
 * REST controller for managing {@link com.bookingcar.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
...
//    public ResponseEntity<Customer> updateCustomer(
//        @PathVariable(value = "id", required = false) final Long id,
//        @Valid @RequestBody CustomerRegisterPayload payload
//    ) throws URISyntaxException {
//        log.debug("REST request to update Customer : {}, {}", id, payload);
//
//        if (!customerRepository.existsById(id)) {
//            throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
//        }
//        if (!use)
//
//        Customer updateCustomer = customerService.findOne(id).get();
//
//        updateCustomer.
//
//        Customer result =
