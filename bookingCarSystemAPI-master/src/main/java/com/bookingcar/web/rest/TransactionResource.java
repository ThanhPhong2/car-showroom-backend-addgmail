...
import com.bookingcar.repository.TransactionRepository;
import com.bookingcar.service.TransactionService;
...
/**
 * REST controller for managing {@link com.bookingcar.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
