...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPATTRIBUTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPATTRIBUTE actions', async () => {
      const expectedActions = [
        {
