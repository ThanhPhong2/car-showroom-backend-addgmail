  ...
  return (
    <div>
      <h2 id="wallet-heading" data-cy="WalletHeading">
        <Translate contentKey="bookingCarApiApp.wallet.home.title">Wallets</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="bookingCarApiApp.wallet.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/wallet/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="bookingCarApiApp.wallet.home.createLabel">Create new Wallet</Translate>
          </Link>
        </div>
      </h2>
        ...
        {walletList && walletList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="bookingCarApiApp.wallet.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="bookingCarApiApp.wallet.balance">Balance</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bookingCarApiApp.wallet.home.notFound">No Wallets found</Translate>
            </div>
          )
        )}
      </div>
