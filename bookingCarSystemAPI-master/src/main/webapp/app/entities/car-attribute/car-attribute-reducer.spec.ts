...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARATTRIBUTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARATTRIBUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARATTRIBUTE actions', async () => {
      const expectedActions = [
        {
