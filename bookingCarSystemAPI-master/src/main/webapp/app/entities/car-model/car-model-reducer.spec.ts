...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './car-model.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARMODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARMODEL actions', async () => {
      const expectedActions = [
        {
