...
export const AttributeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bookingCarApiApp.attribute.delete.question">
        <Translate contentKey="bookingCarApiApp.attribute.delete.question" interpolate={{ id: attributeEntity.id }}>
