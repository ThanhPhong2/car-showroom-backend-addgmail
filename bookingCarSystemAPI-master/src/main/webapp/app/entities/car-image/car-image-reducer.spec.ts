...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './car-image.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARIMAGE actions', async () => {
      const expectedActions = [
        {
