...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './show-room.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHOWROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHOWROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHOWROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHOWROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHOWROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHOWROOM actions', async () => {
      const expectedActions = [
        {
