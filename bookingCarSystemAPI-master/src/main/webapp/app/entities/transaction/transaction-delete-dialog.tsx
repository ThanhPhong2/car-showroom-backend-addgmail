...
export const TransactionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bookingCarApiApp.transaction.delete.question">
        <Translate contentKey="bookingCarApiApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
