    ...
    <Row>
      <Col md="8">
        <h2 data-cy="transactionDetailsHeading">
          <Translate contentKey="bookingCarApiApp.transaction.detail.title">Transaction</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>
            {transactionEntity.issueDate ? (
              <TextFormat value={transactionEntity.issueDate} type="date" format={APP_LOCAL_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
            <span id="amount">
